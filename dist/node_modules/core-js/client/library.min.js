...
!function (e, i, Jt) {
  ...
  !function (r) {
    ...
    var h = r(31),
      ...
      for (var r = y(t), e = arguments.length, i = 1, o = p.f, u = v.f; i < e;) for (var c, f = g(arguments[i++]), a = o ? h(f).concat(o(f)) : h(f), s = a.length, l = 0; l < s;) u.call(f, c = a[l++]) && (r[c] = f[c]);return r;
    } : i;
  }, function (t, n) {
    t.exports = function (t, n, r) {
    ...
    var e = r(2),
      ...
      _(t);for (var r, e = g(n = S(n)), i = 0, o = e.length; i < o;) H(t, r = e[i++], n[r]);return t;
    },
      ...
      for (var n, r = k(S(t)), e = [], i = 0; i < r.length;) u(U, n = r[i++]) || n == R || n == f || e.push(n);return e;
    },
        Q = function getOwnPropertySymbols(t) {
      for (var n, r = t === G, e = k(r ? W : S(t)), i = [], o = 0; o < e.length;) !u(U, n = e[o++]) || r && !u(G, n) || i.push(U[n]);return i;
      ...
      return K(p(t));
    }), o(o.G + o.W + o.F * !V, { Symbol: A });for (var tt = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), nt = 0; nt < tt.length;) p(tt[nt++]);for (var rt = E(p.store), et = 0; et < rt.length;) y(rt[et++]);o(o.S + o.F * !V, "Symbol", { "for": function (t) {
