        ...
        function reportUnnecessaryBraceError(node, bodyNode, name, suffix) {
            context.report({
                ...
                fix(fixer) {
                     ...
                     */
                    const needsPrecedingSpace = node.type === "DoWhileStatement" && sourceCode.getTokenBefore(bodyNode).range[1] === bodyNode.range[0] && !astUtils.canTokensBeAdjacent("do", sourceCode.getFirstToken(bodyNode, { skip: 1 }));
