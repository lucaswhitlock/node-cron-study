...
module.exports = {
    ...
    create(context) {
        ...
        function getCommentLines(commentGroup) {
            ...
            return commentGroup[0].value.split(astUtils.LINEBREAK_MATCHER).map(line => line.replace(/^\s*\*?/, ""));
        }
        ...
        function isJSDoc(commentGroup) {
            ...
            return commentGroup[0].type === "Block" && /^\*\s*$/.test(lines[0]) && lines.slice(1, -1).every(line => /^\s* /.test(line)) && /^\s*$/.test(lines[lines.length - 1]);
        }
