...
class RuleTester {
    ...
    constructor(testerConfig) {
        ...
        lodash.cloneDeep(defaultConfig), testerConfig, { rules: { "rule-tester/validate-ast": "error" } });
     ...
     */
    static get describe() {
        return this[DESCRIBE] || (typeof describe === "function" ? describe : defaultHandler);
    }
    ...
    static get it() {
        return this[IT] || (typeof it === "function" ? it : defaultHandler);
    }
    ...
    run(ruleName, rule, test) {
        ...
        function testInvalidTemplate(item) {
            ...
            if (item.hasOwnProperty("output")) {
                if (item.output === null) {
                    assert.strictEqual(messages.filter(message => message.fix).length, 0, "Expected no autofixes to be suggested");
                } else {
