...
function processFile(filename, configHelper, options, linter) {
    ...
    const text = fs.readFileSync(path.resolve(filename), "utf8"),
          result = processText(text, configHelper, filename, options.fix, options.allowInlineConfig, options.reportUnusedDisableDirectives, linter);
...
class CLIEngine {
    ...
    constructor(options) {
        ...
        options = Object.assign(Object.create(null), defaultOptions, { cwd: process.cwd() }, options);
    ...
    executeOnText(text, filename, warnIgnored) {
        ...
        if (filename && ignoredPaths.contains(filename)) {
            ...
            results.push(processText(text, configHelper, filename, options.fix, options.allowInlineConfig, options.reportUnusedDisableDirectives, this.linter));
        }
